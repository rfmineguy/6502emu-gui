...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "3.3.8"
  WORKING_DIRECTORY "/Users/rileyfischer/Documents/dev/cpu_emulators/6502emu_gui/build/_deps/glfw-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/rileyfischer/Documents/dev/cpu_emulators/6502emu_gui/build/_deps/glfw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/rileyfischer/Documents/dev/cpu_emulators/6502emu_gui/build/_deps/glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
